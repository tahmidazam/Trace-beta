...
struct Electrode: Identifiable, Codable, Equatable, Hashable {
    ...
    ///
    /// - Returns: The location of the electrode on the scalp, in polar coordinate form.
    func location() -> Polar? {
        switch prefix {
        case .prefrontal:
            switch suffix {
    ...
    func sector(in size: CGSize) -> Path? {
        ...
        case .prefrontal:
            switch suffix {
            case 1: return Electrode.path(size: size, eR: 5 / 7, sR: 3 / 7, sA: 0, eA: 0.1)
            case 2: return Electrode.path(size: size, eR: 5 / 7, sR: 3 / 7, sA: 0.9, eA: 0)
            default: return nil
            }
        case .frontal:
            switch suffix {
            case 0: return Electrode.path(size: size, eR: 3 / 7, sR: 1 / 7, sA: 0.9375, eA: 0.0625)
            case 3: return Electrode.path(size: size, eR: 3 / 7, sR: 1 / 7, sA: 0.8125, eA: 0.9375)
            case 4: return Electrode.path(size: size, eR: 3 / 7, sR: 1 / 7, sA: 0.0625, eA: 0.1875)
            case 7: return Electrode.path(size: size, eR: 5 / 7, sR: 3 / 7, sA: 0.8, eA: 0.9)
            case 8: return Electrode.path(size: size, eR: 5 / 7, sR: 3 / 7, sA: 0.1, eA: 0.2)
            default: return nil
            }
        case .temporal:
            switch suffix {
            case 3: return Electrode.path(size: size, eR: 5 / 7, sR: 3 / 7, sA: 0.7, eA: 0.8)
            case 4: return Electrode.path(size: size, eR: 5 / 7, sR: 3 / 7, sA: 0.2, eA: 0.3)
            case 5: return Electrode.path(size: size, eR: 5 / 7, sR: 3 / 7, sA: 0.6, eA: 0.7)
            case 6: return Electrode.path(size: size, eR: 5 / 7, sR: 3 / 7, sA: 0.3, eA: 0.4)
            default: return nil
            }
        case .parietal:
            switch suffix {
            case 0: return Electrode.path(size: size, eR: 3 / 7, sR: 1 / 7, sA: 0.4375, eA: 0.5625)
            case 3: return Electrode.path(size: size, eR: 3 / 7, sR: 1 / 7, sA: 0.5625, eA: 0.6875)
            case 4: return Electrode.path(size: size, eR: 3 / 7, sR: 1 / 7, sA: 0.3125, eA: 0.4375)
            default: return nil
            }
        case .occipital:
            switch suffix {
            case 1: return Electrode.path(size: size, eR: 5 / 7, sR: 3 / 7, sA: 0.4, eA: 0.5)
            case 2: return Electrode.path(size: size, eR: 5 / 7, sR: 3 / 7, sA: 0.5, eA: 0.6)
            default: return nil
            }
        case .central:
            switch suffix {
            ...
            case 3: return Electrode.path(size: size, eR: 3 / 7, sR: 1 / 7, sA: 0.6875, eA: 0.8125)
            case 4: return Electrode.path(size: size, eR: 3 / 7, sR: 1 / 7, sA: 0.1875, eA: 0.3125)
            default: return nil
            }
        case .mastoid:
            switch suffix {
            case 1: return Electrode.path(size: size, eR: 7 / 7, sR: 5 / 7, sA: 0.725, eA: 0.775)
            case 2: return Electrode.path(size: size, eR: 7 / 7, sR: 5 / 7, sA: 0.225, eA: 0.275)
            default: return nil
            }
        }
    }
    ...
    struct Polar {
        ...
        var radius: Double
        /// The angle of the vector, ranging from `0` to `1`.
        var angle: Double
